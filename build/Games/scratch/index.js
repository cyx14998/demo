    ...
    ScratchPad.prototype =
	{
	    ...
	    setBgImage: function () {
	        if (this.settings.image) {
	            ...
	            this.sp.css('background-size', String(this.settings.width) + 'px ' + String(this.settings.height)+'px')
	        }
	    },
        ...
        $($this.canvas).css('margin-right', $($this.canvas).css('margin-right') == "0px" ? "1px" : "0px")//����ֻ��β�������
