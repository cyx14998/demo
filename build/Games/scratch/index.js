(function ($) {
    ...
    $.fn.wScratchPad.defaultSettings = {
        ...
        image: 'images/Scratch/0.jpg', // set image path
        image2: 'images/Scratch/scratch_area1.png', // set overlay image path - if set color is not used
    ...
    ScratchPad.prototype = {
        generate: function () {
            ...
            this.sp = $('<div></div>')
                ...
                .append($(this.canvas).attr('width', this.settings.width + 'px').attr('height', this.settings.height + 'px'))
        ...
        init: function () {
            ...
            if (this.settings.image2) {
                ...
                this
                    .ctx
                    .rect(0, 0, this.settings.width, this.settings.height)
                this
                    .ctx
                    .fill();
            }
        ...
        setBgImage: function () {
            if (this.settings.image) {
                ...
                this
                    .sp
                    .css('background-size', String(this.settings.width) + 'px ' + String(this.settings.height) + 'px')
            }
        },
        ...
        scratchFunc: function (e, $this, event) {
            ...
            if (this.settings.realtimePercent || event == "Up") {
                if ($this.settings['scratch' + event]) 
                    $this.settings['scratch' + event].apply($this, [
                        e, $this.scratchPercentage($this)
                    ]);
                }
            },
        ...
        scratchDown: function (e, $this) {
            $($this.canvas).css('margin-right', $($this.canvas).css('margin-right') == "0px"
                ? "1px"
                : "0px") //����ֻ��β�������
            ...
            $this
                .ctx
                .arc(e.pageX, e.pageY, $this.settings.size / 2, 0, Math.PI * 2, true);
            $this
                .ctx
                .closePath();
            $this
