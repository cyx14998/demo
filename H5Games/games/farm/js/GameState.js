...
(function () {
    ...
    FZ.Game.GameState = new(FZ.newClass({
        ...
        CUR_BTN_DEFS: [/*["BTN_MAIN_MENU_ICON", "BTN_MAIN_MENU_ICON_TOUCH"], */
            [
                "BTN_HINT", "BTN_HINT_TOUCH"
            ],
            ["BTN_PAUSE", "BTN_PAUSE_TOUCH"]/*, ["BTN_SOUND", "BTN_SOUND_TOUCH"],*/
        ],
        CUR_BTN_ANDROID_DEFS: [/*["BTN_MAIN_MENU_ICON", "BTN_MAIN_MENU_ICON_TOUCH"], */
            [
                "BTN_HINT", "BTN_HINT_TOUCH"
            ],
        ...
        CUR_SWITCH_DEFS: [
            "BTN_GAME_BACK", "BTN_GAME_BACK_TOUCH"
        ],
        ...
        createLevelTextSprite: function (x, y, w, h, text, color, size) {
            ...
            spr.style.textShadow = "-1px -1px 1px #ffffff, 1px 1px 1px #ffffff, 1px -1px 1px #ffffff, -1px 1px 1px #" +
                    "ffffff ";
        ...
        createPauseTextSprite: function (divSprite, text, color, size) {
            ...
            spr.style.fontSize = Math.round(h) + "px";
            // add shadow from up down left and right
            spr.style.textShadow = "-2px -2px 2px #B97F00, 2px 2px 2px #B97F00, 2px -2px 2px #B97F00, -2px 2px 2px #" +
                    "B97F00 ";
            spr.style.color = color;
            spr.innerHTML = text;
        },
        ...
        resume: function () {
            ...
            if (null !== this.m_diamondMgr) {
                ...
                if (FZ.StateDefs.GAME_STATE_OVER == statename) {
                    ...
                    this
                        .m_btn_list[this.BTN_HINT_INDEX]
                        .setEnable(true);
                    this
                        .m_diamondMgr
                        .initAllPets(true);
                    ...
                    this
                        .m_diamondMgr
                        .setHintCount(FZ.GameBase.SaveObject.m_hint);
                    this
                        .m_diamondMgr
                        .setLevel(FZ.GameBase.SaveObject.m_cur_level);
                    ...
                    this
                        .m_diamondMgr
                        .setParent(this.m_main_div);
                } else if (FZ.StateDefs.GAME_STATE_NEXT_LEVEL == statename) {
                    this.m_btn_list[this.BTN_HINT_INDEX].m_div.style.backgroundImage = "url(imgs/" + this.m_btn_list[this.BTN_HINT_INDEX].m_img_list[0] + ")";
                    this.m_time_bar_div.style.width = this.m_time_bar_w + "px";
                    this
                        .m_btn_list[this.BTN_HINT_INDEX]
                ...
                } else if (FZ.StateDefs.GAME_STATE_RESET == statename) {
                    if (arguments.length > 1) {
                        if (arguments[1] === "yes") {
                            ...
                            setTimeout(function () {
                                FZ
                                    .GameBase
                                    .switchToState(FZ.StateDefs.GAME_STATE_MAINMEN);
                            }, 100);
        ...
        preProcess: function (preState) {
            ...
            if (!this.m_load_ui) {
                ...
                FZ
                    .GameBase
                    .setCss(this.m_pause_div, info);
                this
                    .m_main_div
                    .appendChild(this.m_pause_div);
                ...
                FZ
                    .GameBase
                    .setCss(this.m_str_nomatch_div, info);
                this
                    .m_main_div
                    .appendChild(this.m_str_nomatch_div);
                ...
                var len = FZ
                    .AG
                    .SearchSpecialPath
                    .setNumDiv(this.m_hint_num_div, hintNum);
                while (len > 0) {
                    this
                        .m_main_div
                        .appendChild(this.m_hint_num_div[len - 1]);
                    len--;
                }
                ...
                if (FZ.TargetMobile !== FZ.TARGET_DEF.ANDRIOD) {
                    ...
                    //                    this.m_btn_list[this.BTN_HINT_INDEX].m_div.style.left =
                    // 184 + "px";
                }
                info = FZ.getImgInfo(this.CUR_SWITCH_DEFS[0]);
                cloneInfo = FZ.getImgInfo(this.CUR_SWITCH_DEFS[1]);
                this
                    .m_btn_list[this.BTN_PAUSE_INDEX]
                    .setSwitchButton(info.fileURL, cloneInfo.fileURL);
                /*
                if (FZ.TargetMobile !== FZ.TARGET_DEF.ANDRIOD) {
            ...
            // 			//the code just for test. 			document.addEventListener("keyup",
            // FZ.Tools.bindWithEvent(this, this.gamekeyup), false);
            ...
            if ((FZ.StateDefs.GAME_STATE_MAINMEN === preState) || (FZ.StateDefs.GAME_STATE_OVER === preState) || (FZ.StateDefs.GAME_STATE_HELP === preState)) {
        ...
        postProcess: function () {
            ...
            this
                .m_diamondMgr
                .removeEvent();
            if (this.m_next_state === FZ.StateDefs.GAME_STATE_OVER || this.m_next_state === FZ.StateDefs.GAME_STATE_RESET || this.m_next_state === FZ.StateDefs.GAME_STATE_NEXT_LEVEL || this.m_next_state === FZ.StateDefs.GAME_STATE_GAME_WIN) {
                this.m_main_div.style.display = "inline";
        ...
        checkOver: function () {
            ...
            if (!this.m_levelStart) {
                ...
                var isTouched = false;
                //   this.m_ui_list[this.UI_ARROW_START_INDEX + level - 3].style.display =
                // "inline";
                var scoreNum = FZ
                    .AG
                    .SearchSpecialPath
                    .setScoreNum(FZ.GameBase.SaveObject.score + this.m_diamondMgr.getScore());
                ...
                //                FZ.EventRemove(this, this.m_main_div, FZ.EVENT_DEF.T_START,
                // this.m_call_tStart);                FZ.EventRemove(this, this.m_main_div,
                // FZ.EVENT_DEF.M_CLICK, this.m_call_mClick);
                ...
                //                this.m_timer = setTimeout(FZ.Tools.bind(this, this.checkOver),
                // 200);
        ...
        checkWin: function () {
            ...
            if (this.m_diamondMgr.getLeftPet() === 0) {
                ...
                var levelUsedHint = FZ.GameBase.SaveObject.m_hint - this
                    .m_diamondMgr
                    .getHintCount();
                ...
                var scoreNum = FZ
                    .AG
                    .SearchSpecialPath
                    .setScoreNum(FZ.GameBase.SaveObject.score + levelscore);
                ...
                if (level === FZ.GameDefs.MAX_LEVEL_RANK) {
                    ...
                    FZ
                        .GameBase
                        .switchToState(FZ.StateDefs.GAME_STATE_GAME_WIN, levelscore + score, totalUsedTime, totalUsedHint);
                    FZ.GameBase.SaveObject.pass = true;
                    FZ.GameBase.SaveObject.score += levelscore;
                    FZ.GameBase.SaveObject.m_hint = this
                        .m_diamondMgr
                        .getHintCount(); // + FZ.GameDefs.LEVEL_HINT_NUMBER[level];
                    FZ
                        .GameBase
                        .saveGame();
                    return;
                    ...
                    FZ
                        .GameBase
                        .pushState(this.StateName);
                    FZ
                        .GameBase
                        .switchToState(FZ.StateDefs.GAME_STATE_NEXT_LEVEL, levelscore, timeBonus, levelUsedHint);
                    FZ.GameBase.SaveObject.score += levelscore;
        ...
        setNextLevel: function (levelscore, totalscore) {
            ...
            FZ
                .GameBase
                .switchToState(FZ.StateDefs.GAME_STATE_NEXT_LEVEL, levelscore, totalscore);
        ...
        setGameWin: function (levelscore, totalscore) {
            ...
            FZ
                .GameBase
                .switchToState(FZ.StateDefs.GAME_STATE_GAME_WIN, levelscore, totalscore);
        ...
        buttonClick: function (btn) {
            ...
            if (this.m_btn_list[this.BTN_HINT_INDEX] === btn) {
            ...
            } else if (this.m_btn_list[this.BTN_PAUSE_INDEX] === btn) {
                this.m_gamePause = !this.m_gamePause;
                if (this.m_gamePause === true) {
                    ...
                    this.m_diamondMgr.m_reset_finished = true;
                    //
                    // FZ.Game.GameState.m_btn_list[FZ.Game.GameState.BTN_HOME_INDEX].m_div.style.bac
                    // kgroundImage = "url(imgs/BTN_HOME.png)";
                    if ((this.m_diamondMgr.getHintCount()) !== 0) {
        ...
        debugLevel: function () {
            ...
            var levelscore = this
                .m_diamondMgr
                .getScore() + this.m_levelLeftTime * 20;
            ...
            if (level === 9) {
                ...
                FZ
                    .GameBase
                    .switchToState(FZ.StateDefs.GAME_STATE_GAME_WIN, this.m_levelLeftTime, levelscore);
                return;
            } else {
                clearTimeout(this.m_timer);
                this
                ...
                FZ
                    .GameBase
                    .switchToState(FZ.StateDefs.GAME_STATE_NEXT_LEVEL, this.m_levelLeftTime, levelscore);
                return;
            }
        },

        // 		update : function() { 			var mySelf = this; 			switch(substate) { 				case
        // "init": 				{ 					//function_init(); 					//{ 					// if(time > 3) { 					//
        //    substate = "playing"; 					// } 					//} 					break; 				} 				case
        // "playing": 				{ 					//function_playing(); 					//{ 					//
        // this.checkover(); 					//	  { 					//			time < 0; 					//    } 					//}
        // 					break; 				} 				case "end": 				{ 					//function_end(); 					break;
        ...
        pageShow: function (e) {
            ...
            //       FZ.Game.GameState.levelPauseTime +=
            // FZ.Game.GameState.levelPauseEndTime - FZ.Game.GameState.levelPauseStartTime;
